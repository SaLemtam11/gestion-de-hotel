...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  if (isset($_POST['search1'])) {
    if (!empty($_POST['search1'])) {
      $s_earch    =  $_POST['search1'] ;
      $Q = "SELECT * FROM archives WHERE nom_client LIKE '%$s_earch%' or prenom_client LIKE '%$s_earch%' or email LIKE '%$s_earch%' ;";
    }
  }
...
if(!isset($Q))  $Q = "SELECT * FROM archives LIMIT 0 ,0 ;";
